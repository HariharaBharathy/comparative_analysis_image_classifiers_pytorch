...
class ClassifierNetwork(nn.Module):
    """
            Backbone of classifier is ResNet
    """

    def __init__(self):
        super(ClassifierNetwork, self).__init__()

        self.cnn_base = resnet18(weights=ResNet18_Weights)
        self.cnn_base.fc = nn.Linear(in_features=self.cnn_base.fc.in_features, out_features=196,bias=True)
...
def main():
    ...
    parser.add_argument('--experiment-name', type=str, default="Stanford_cars_resnet18", metavar='N',
