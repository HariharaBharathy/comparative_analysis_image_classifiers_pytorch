...
class ClassifierNetwork(nn.Module):
    ...
    def __init__(self):
        ...
        self.cnn_base = torchvision.models.vgg19_bn(weights="VGG19_BN_Weights.IMAGENET1K_V1")
        self.cnn_base.avgpool = nn.AdaptiveAvgPool2d((1, 1))
        self.cnn_base.classifier = torch.nn.Sequential(nn.Linear(in_features=512, out_features=1024, bias=True),
                                                       nn.ReLU(inplace=True),
                                                       nn.Dropout(p=0.5, inplace=False),
                                                       nn.Linear(in_features=1024, out_features=196, bias=True))
...
def main():
    ...
    parser.add_argument('--experiment-name', type=str, default="Stanford_cars_vgg19_without_early_stopping_lightweight_with_bn_dropout", metavar='N',
